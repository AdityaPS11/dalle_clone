  ...
  return (
    <section className="max-w-7xl mx-auto">
        <div>
            ...
            max-w-[500px]'>Create imaginative and stunning images through DALL-E and share them with community</p>
        </div>
        ...
        <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
            <div className="flex flex-col gap-5">
                ...
                <FormField
                    ...
                    type = "text"
                    name="prompt"
                    placeholder="A plush toy robot sitting against a
                    yellow wall"
                    value={form.prompt}
                    handleChange = {handleChange}
                    isSurpriseMe
                ...
                focus:ring-blue-500 focus:border-blue-500 w-64 p-3h-64 flex justify-center
                items-center">
                    {form.photo ? (
                        <img 
                            src={form.photo}
            ...
            <div className="mt-10">
                <p className="mt-2 text-[#666e75] text-[14px]">
                    Do share the image with others in the community.😊
                </p>
                <button
                    type="submit"
